...
public class Aufgabe7 {
	...
	for(int i = num, iteration = 1; i >= 0; i = i - 1){
	    for(int j = 0; j < iteration; j = j + 1){
		myDrawObj.setColor(new Color(255 - i * 30, 255 - i * 30, 0));
		myDrawObj.fillCircle(256, yStart, currRadius);
		yStart = yStart + currRadius * 2;
	    }
    ...
    public static void main(String[] args) {
        ...
        drawCirclesIterHand(myDrawObjIHand, pixelHeight/2, pixelWidth/2, 4);
        myDrawObjIHand.show();
    }
}
