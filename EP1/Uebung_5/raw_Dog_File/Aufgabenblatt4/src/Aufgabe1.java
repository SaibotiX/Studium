...
//**************************************************************************
//Antwort zu Punkt a:
//Es kommt zu einem Fehler da einerseits die gesamte Länge durchiteriert werden möchte, was bei einem Array dazu führt dass man in einem Bereich kommt der nicht definiert ist und zusätzlich noch beim Print das i minus 1 gerechnet wird, was wenn i = 0 ist zu i = -1 führt was ebenfalls nicht definiert ist.
//Antwort zu Punkt b:
...
//
//Antwort zu Punkt d:
//Wenn man in einer Methode das Übergebene Array auf ein neu definiertes Array referenziert, kann man in der Methode mit der neuen Referenz arbeiten. Falls man aber dieses neu referenzierte Array nicht mittels
//return statement zurückgibt, zeigt dann das Array wieder auf den Ürsprünglichen Referenzplatz und somit gehen die Änderungen auf der anderen Referenz verloren.
//
